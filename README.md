...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-igng-uc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-igng-uc.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-igng-uc.git
cd container-igng-uc
```
...
```
docker attach container-igng-uc
```
